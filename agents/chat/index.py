...
SYSTEM_PROMPT = (
  ...
  '## Project Skills (MUST use Skill tool to load before using)\n'
  '- chatbi-analysis: EDA, forecasting, ABC/XYZ, inventory, pricing + orchestration routing\n'
  '- clean-data-xls: detect & fix messy data (whitespace, casing, dates, duplicates, encoding)\n'
  ...
  'CRITICAL: Use the Skill tool to LOAD chatbi-analysis before any data task.\n'
  'Use the Skill tool to LOAD clean-data-xls if data looks messy.\n'
  'Skill tool usage is VISIBLE to users — they can see what you are using.\n\n'
  '## Analysis\n'
