...
SYSTEM_PROMPT = (
  ...
  '- clean-data-xls: detect & fix messy data (whitespace, casing, dates, duplicates, encoding, etc)\n'
  ...
  'IMPORTANT: Before analyzing any uploaded file, check data quality first.\n'
  'If issues found, use clean-data-xls skill.\n\n'
  '## Analysis\n'
